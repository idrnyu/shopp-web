...
export const PRODUCT_LIST = {
  antminer: [
    {
      id: 1,
      img1: getImageUrl('./imgs/antminer/antminer-test1.png'),
      img2: getImageUrl('./imgs/antminer/antminer-test2.png'),
    ...
    {
      id: 2,
      img1: getImageUrl('./imgs/antminer/antminer-test2.png'),
      img2: '',
      title: 'Antminer S19J pro104th/s Bicoin Miner 3120w Asic Miner Cheaper Than Antminer S19pro  110th',
      price: '100',
      originalcost: '200',
    ...
    },
    {
      id: 2,
      img1: getImageUrl('./imgs/antminer/antminer-test2.png'),
      img2: getImageUrl('./imgs/antminer/antminer-test1.png'),
      title: 'Antminer S19J pro104th/s Bicoin Miner 3120w Asic Miner Cheaper Than Antminer S19pro  110th',
      price: '100',
      originalcost: '200',
    },
  ...
  avalon: [
    {
      id: 1,
      img1: getImageUrl('./imgs/avalon/avalon-01.png'),
      img2: '',
  ...
  whatsminer: [
    {
      id: 1,
      img1: getImageUrl('./imgs/whatsminer/whatsminer-test1.png'),
      img2: getImageUrl('./imgs/whatsminer/whatsminer-test2.png'),
    ...
    {
      id: 2,
      img1: getImageUrl('./imgs/whatsminer/whatsminer-test2.png'),
      img2: getImageUrl('./imgs/whatsminer/whatsminer-test1.png'),
